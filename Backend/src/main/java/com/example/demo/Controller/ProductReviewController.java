...
public class ProductReviewController {
    ...
    // ================= ADD REVIEW (RETAILER) =================
    @PostMapping
    public Review addReview(@RequestBody Map<String, Object> data) {

        if (
            data.get("productId") == null ||
            data.get("retailerId") == null ||
            data.get("rating") == null ||
            data.get("comment") == null
        ) {
            throw new RuntimeException("Missing required review fields");
        }
    ...
    public List<Review> getReviewsForFarmer(@PathVariable Long farmerId) {
